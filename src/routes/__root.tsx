...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Track manga, manhwa, manhua, and comics on one screen and keep progress synced across devices." },
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <head>
        <HeadContent />
        {/* Runs before hydration so the right theme class is on <html> from
            first paint — prevents a flash of the wrong theme. */}
